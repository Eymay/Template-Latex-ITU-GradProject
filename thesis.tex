...
\yazarbir{Student Name}{SURNAME}
\ogrencinobir{101010101}
\yazariki{Student Name}{SURNAME}
\ogrencinoiki{101010102}
\yazaruc{Student Name}{SURNAME}
\ogrencinouc{101010103}
...
\input{chapter_01}                                       
\cleardoublepage %dirty fix to start chapters in odd pages
\input{chapter_02}
\cleardoublepage 
\input{chapter_03}
\cleardoublepage 
...
\ozgecmisbir{\input{resume1}} 
\ozgecmisiki{\input{resume2}} 
\ozgecmisuc{\input{resume3}} 

\edge{\input{edge}}% Edge (Sırt) of the thesis at the very end.
